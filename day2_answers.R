...
## Read the data
gapminder_df <- read.csv("gapminder_df_edit.csv")
...
## for the year 2007
gapminder_2007 <- gapminder_df3[gapminder_df3$year == 2007, ]
plot(gapminder_2007$lifeExp, gapminder_2007$pop)
...
gapminder_2007_europe <- gapminder_df3[(gapminder_df3$year == 2007) &
    (gapminder_df3$continent == "Europe"), ]

plot(gapminder_2007_europe$gdpPercap, gapminder_2007_europe$lifeExp)

gapminder_2007_africa <- gapminder_df3[(gapminder_df3$year == 2007) &
    (gapminder_df3$continent == "Africa"), ]
plot(gapminder_2007_africa$gdpPercap, gapminder_2007_africa$lifeExp)
